...
<img src="http://aikaid-img.oss-cn-shanghai.aliyuncs.com/img/image-20211130222113461.png" alt="image-20211130222113461" style="zoom:150%;" />

1. 首先将整个项目分为多个服务部分，每个部分负责一种业务。
2. 其中这些业务可能会进行相互调用，所以我们需要一个注册中心进行管理。
3. 同时需要一个配置中心，对各个配置进行统一管理
4. 有多个数据库，同时也会有对应的缓存技术和分布式搜索技术
5. 需要一个同一的网关进行请求路由和负载均衡
6. 需要日志服务和监控系统
7. 使用Jenkins，docker，k8s等进行部署

### 1.1.2 技术细分

![image-20211130223055041](http://aikaid-img.oss-cn-shanghai.aliyuncs.com/img/image-20211130223055041.png)
...
- 微服务的架构特征：
  ...
  ![image-20210713203753373](http://aikaid-img.oss-cn-shanghai.aliyuncs.com/img/image-20210713203753373.png)
...
![微服务技术对比](http://aikaid-img.oss-cn-shanghai.aliyuncs.com/img/image-20211130225810494.png)
